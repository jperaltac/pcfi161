...
export const FechaLinks = () => {
  ...
  if (available) {
    return (
      <ul>
        ...
        <li>
          ...
          <blockquote>
            Este archivo contiene los <em>slides</em> de la segunda clase de la tercera semana. Además incorpora la actividad de tarea semanal a ser entregada.
          </blockquote>
        </li>
      </ul>
    );
    ...
    return (
      <strong>El material estará disponible a partir del 17 de marzo de 2025.</strong>
    );
  }
}
