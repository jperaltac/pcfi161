...
% ------------------------------------------------------------------------
\begin{frame}
  \frametitle{Resumen - Semana 3, Sesión 2}
  \framesubtitle{Versión resumida: problemas guiados y conclusiones}
  \tableofcontents
\end{frame}
...
% ----------------------------------------------------------------------------------------
% SECCIONES COMENTADAS: se deja visible solo problemas guiados y conclusiones
% ----------------------------------------------------------------------------------------
\iffalse
...
% Este bloque aparece solo cuando se compila con SHOWSOLUTIONS=1.
\begin{solutionblock}
\section{Soluciones de Referencia}
\begin{frame}{Soluciones de Referencia}
  \small
  Las soluciones de referencia de esta sesión aún no están incorporadas en
  \texttt{Semana03-P2.tex}. Cuando se agreguen aquí, aparecerán solo en la
  compilación con respuestas.
\end{frame}
\end{solutionblock}
