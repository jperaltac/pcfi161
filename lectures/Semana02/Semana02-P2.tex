...
% Control de visibilidad de soluciones:
%   \showsolutionstrue  -> muestra soluciones
%   \showsolutionsfalse -> oculta soluciones
...
\begin{frame}{Ejercicio 2: \hfill \textcolor{red}{$\clubsuit$} \\ Promedio y Varianza de Mediciones}
  ...
  \textbf{Conceptos:} Bucles \texttt{for}, acumuladores, estadística básica.
  \\
...
% ------------------------------------------------------------------------
% Slide11:  Ejercicio 5 -  Cálculo de una suma
% ------------------------------------------------------------------------
\begin{frame}{Ejercicio 5: \hfill \textcolor{red}{$\clubsuit$} \\ Cálculo de una suma}
  \begin{block}{Enunciado}
    \footnotesize
    ...
    \begin{itemize}
      \item En muchos cálculos de física es necesario evaluar sumas numéricas.
      \item Considere la suma \( s = \sum_{k=1}^{100} \frac{1}{k} \).
      \item Cree una variable \texttt{s} para almacenar el valor de la suma e inicialícela en \texttt{0.0}.
      \item Use un bucle \texttt{for} para recorrer los valores de \(k\) desde \(1\) hasta \(100\).
      \item En cada iteración calcule \(1/k\) y agréguelo al valor de \texttt{s}.
      \item agruegue condicionales para mostrar mensajes de progreso. (ej; k = 20 , 40 , etc) 
      \item Al finalizar el bucle, imprima el valor final de la suma.
    \end{itemize}
  \end{block}
\vspace{-1.0em}
  \footnotesize
  \textbf{Conceptos:} Bucles \texttt{for}, acumuladores, sumas numéricas. \\
  \textbf{Física relevante:} Evaluación de sumas en cálculos físicos.
\end{frame}
...
\end{minted}
\vspace{-0.4em}
{\scriptsize \textbf{Discusión:} Bucles anidados, contadores múltiples, clasificación con condicionales.}
\end{frame}
\fi
