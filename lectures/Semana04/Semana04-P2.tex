...
\begin{frame}{Ejercicio 3: \hfill \textcolor{red}{$\clubsuit$} \\ Conversión de lista de temperaturas}
  \begin{block}{Enunciado}
    ...
    \end{itemize}
  \end{block}
  \textbf{Conceptos:} Listas, bucles, operadores \\ usar {\texttt{\textcolor{blue}{NombreLista.append(ValorAgregar)}}}.\\
  \textbf{Física relevante:} Termodinámica básica.
\end{frame}
\fi

% Ejercicio 3 (Intermedio)
\begin{frame}{Ejercicio 3: \hfill \textcolor{red}{$\clubsuit$} \\ Cálculo de energía potencial gravitatoria}
  \begin{block}{Enunciado}
    \begin{itemize}
...
\begin{frame}{Ejercicio 4: \hfill \textcolor{red}{$\clubsuit$} \\ Tabla de conversión de segundos a horas}
  \begin{block}{Enunciado}
    \begin{itemize}
...
% Ejercicio 5 (Difícil)
\begin{frame}{Ejercicio 5: \hfill \textcolor{red}{$\clubsuit$} \\ Módulo de conversiones físicas avanzadas}
  \begin{block}{Enunciado}
    \begin{itemize}
      \item Crea un módulo \texttt{conversor.py} con funciones para convertir:
        \begin{itemize}
		\item Newtons a kilogramos-fuerza ( 1kgf \approx 9.8 N).
...
% ------------------------------------------------------------------------
\begin{frame}{Ejercicio 6: \hfill \textcolor{red}{$\clubsuit$} \\ Validación y suma de números positivos}
  \begin{block}{Enunciado}
    \begin{itemize}
...
% Ejercicio 7 (Difícil)
% ------------------------------------------------------------------------
\begin{frame}{Ejercicio 7: \hfill \textcolor{red}{$\clubsuit$} \\ Aproximación de la raíz cuadrada por método iterativo}
  \small
  \begin{block}{Enunciado}
    \begin{itemize}
      ...
      \item Usa un ciclo \texttt{for} para realizar 10 iteraciones y mostrar el resultado final.
    \end{itemize}
  \end{block}
...
% Ejercicio 8 (Difícil)
\begin{frame}{Ejercicio 8: \hfill \textcolor{red}{$\clubsuit$} \\ Generador de tabla de valores de una función física}
  \begin{block}{Enunciado}
    \begin{itemize}
...
% Ejercicio 9 (Difícil)
% ------------------------------------------------------------------------
\begin{frame}{Ejercicio 9: \hfill \textcolor{red}{$\clubsuit$} \\ Simulación de crecimiento poblacional}
  \begin{block}{Enunciado}
    \begin{itemize}
...
\begin{frame}{Soluciones de Referencia}
  \small
  Las soluciones de referencia de \texttt{Semana04-P2.tex} deben agregarse en
  este bloque. Este contenido se oculta con \texttt{make} y se muestra con
  \texttt{make pdf-with-answers}.
\end{frame}
\end{solutionblock}
