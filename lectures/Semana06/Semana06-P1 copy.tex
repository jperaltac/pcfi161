...
\begin{frame}{Recapitulación de la Sesión Anterior}
  \begin{itemize}
    \item \textbf{Sesión anterior} se centró en:
      \begin{itemize}
        \item Listas y estructuras de datos básicas
        \item Bucles for y manipulación de colecciones
      \end{itemize}
    \item \textbf{Conexión}: Hoy aplicaremos estos conceptos para trabajar con arreglos numéricos y NumPy.
  \end{itemize}
\end{frame}
...
% ------------------------------------------------------------------------
% Slide C (Ejemplo Práctico con for)
% ------------------------------------------------------------------------
