...
% ------------------------------------------------------------------------
\begin{frame}{Ejercicio 1:  \textcolor{red}{$\clubsuit$} \\ Subplots Seno, Coseno, Tangente}
  \begin{block}{Enunciado}
    \begin{itemize}
...
% ------------------------------------------------------------------------
\begin{frame}{Ejercicio 2: \textcolor{red}{$\clubsuit$} \\ Comparando Histogramas y Barras  }
  \begin{block}{Enunciado}
    \begin{itemize}
...
% ------------------------------------------------------------------------
\begin{frame}{Ejercicio 3: \textcolor{red}{$\clubsuit$} \\ Gráfica 3D de una Función}
  \begin{block}{Enunciado}
    \begin{itemize}
...
% ------------------------------------------------------------------------
\begin{frame}{Ejercicio 4: \textcolor{red}{$\clubsuit$} \\ Leyendo Datos con pandas}
  \begin{block}{Enunciado}
    \begin{itemize}
...
# Histograma
n, bins, patches = ax1.hist(datos, bins=10, color='skyblue', 
...
ax2.bar(centros_bins, n, width=(bins[1]-bins[0])*0.8, 
...
plt.annotate('Altura máxima', 
             xy=(df['Tiempo'][df['PosY'].idxmax()], df['PosY'].max()),
             xytext=(3, 15),
             arrowprops=dict(arrowstyle='->', color='red'))
